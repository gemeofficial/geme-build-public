...
export default function HeroSection({
  ...
  return (
    <SectionContainer className="!pt-0" compact>
      <div className="relative isolate overflow-hidden bg-gradient-to-b from-indigo-100/20 py-20 lg:py-28">
        <div
          aria-hidden="true"
          className="absolute inset-y-0 right-1/2 -z-10 -mr-96 w-[200%] origin-top-right skew-x-[-30deg] bg-white shadow-xl shadow-indigo-600/10 ring-1 ring-indigo-50 sm:-mr-80 lg:-mr-96"
        />
        <div className="mx-auto max-w-2xl lg:mx-0 lg:max-w-none flex flex-col gap-6 lg:flex-row">
          <Image
            width={400}
            height={300}
            alt=""
            src="https://images.unsplash.com/photo-1567532900872-f4e906cbf06a?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1280&q=80"
            className="lg:hidden aspect-[6/5] w-full max-w-lg rounded-2xl object-cover"
          />
