...
export default function WatingListSection({
  ...
  return (
    <SectionContainer compact>
      <div className="text-lg md:text-xl xl:text-[22px] md:text-center font-mono">{introText}</div>
      <SectionTitle className="!text-[#333] mt-12 md:mt-20 xl:mt-24 md:!text-center">
        {title}
      </SectionTitle>
