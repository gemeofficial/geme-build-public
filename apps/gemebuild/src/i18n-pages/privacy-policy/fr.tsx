...
const privacyPolicyProps: IPrivacyPolicyProps = {
  ...
  items: [
    ...
    },
    {
      ...
      description: `
      <p class="mb-15">
      Les données personnelles comprennent toutes les informations relatives à une personne physique identifiée ou identifiable. Une personne est considérée comme identifiable si elle peut être identifiée directement ou indirectement par des moyens tels que le nom, le numéro d'identification, les coordonnées de localisation, l'identifiant en ligne, ou par d'autres caractéristiques telles que physiques, physiologiques, génétiques, psychologiques, économiques, culturelles ou sociales. Cela inclut toutes les informations liées à votre identité, telles que votre nom, votre adresse e-mail ou postale, votre numéro de client et un identifiant en ligne.
      <br /> <br />
    ...
    },
    {
      ...
      description: `
      <p class="mb-15">
      Lorsque nous obtenons votre consentement pour le traitement de vos données personnelles, nous nous appuyons sur l'article 6, paragraphe 1, point a) du RGPD comme base juridique.
      <br /> <br />
    ...
    },
    {
      ...
      description: `
      <p class="mb-15">
      En principe, nous supprimerons ou bloquerons toujours vos données lorsque le stockage n'a plus de sens. Toutefois, Nous pouvons également conserver les données personnelles là où la législation l'exige, comme pour répondre à des obligations légales de conservation et de documentation. Dans ce cas, nous supprimerons ou bloquerons vos données après la fin des procédures.
      </p>
      `,
    },
    {
