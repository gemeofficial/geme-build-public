...
const useCustomerServiceProps = (
  ...
  description: `Discover our comprehensive after-sales support and other interesting service packages for your GEME. We are here for you`,
  links: [
    {
      name: 'Fix By Myself',
      type: 'link',
  ...
  videoLink: {
    name: 'Video Tutorial',
    description: `Learn what you can do to solve the problems of devices.`,
    link: '/manual',
  ...
  item1: [
    {
      image: '',
      name: 'Advice in case of failure',
      description: `Here you can find answers and suggestions for solving your device problems.`,
      link: '/self-repair',
      buttonName: 'Fix By Myself',
      icon: (
        <svg
          className="w-5 h-5"
    ...
    },
    {
      image: '',
      name: 'FAQ',
      description: `Any questions? The FAQ contains a lot of helpful info.`,
      link: '/faq',
      buttonName: 'Find My Answer',
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
    ...
    },
    {
      image: '',
      name: 'Contact Form',
      description: `Use our contact form to send us your request and GEME Service will get back to you as soon as possible.`,
      link: '/contact',
  ...
  item3: [
    {
      name: 'GEME Care+',
      description: `For added security, we offer a warranty on your GEME appliances for up to 3 years upon request. `,
      link: '/geme-care',
    ...
    },
    {
      ...
      description: `Original GEME spare parts ensure the proper operation of your equipment`,
      link: '/addons',
...
export function CustomerServicePageEn({
  PrefetchLink,
}: {
  PrefetchLink?: ILinkComponent
}) {
