...
interface IWarrantyExtendProps {
  title: string
  forward: {
    title: string
    imgSrc: string
...
function WarrantyExtend(props: IWarrantyExtendProps) {
  return (
...
export type { IWarrantyExtendProps }
export { WarrantyExtend }
