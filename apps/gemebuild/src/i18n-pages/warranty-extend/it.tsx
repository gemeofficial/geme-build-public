  ...
  items: [
    {
      ...
      description: `
        ...
        <li class="mb-5">ROKH SRL offre un periodo di garanzia di 1 anno dalla data di acquisto dell'apparecchiatura. Estendendo il periodo di garanzia, ROKH SRL coprirà i costi delle riparazioni per uno o due anni aggiuntivi immediatamente dopo la scadenza del periodo di garanzia. La data di scadenza è indicata sul fronte del documento di garanzia.</li>
        ...
        <li class="mb-5">Le estensioni di garanzia esistenti di 1 anno possono essere estese per un massimo di 3 anni entro il loro periodo di garanzia.</li>
    ...
    },
    {
      ...
      description: `
        ...
        <li class="mb-5">Il documento della polizza deve essere registrato e firmato entro il periodo di garanzia di 1 anno dell'apparecchiatura. Un'estensione di garanzia di un anno può essere ottenuta anche direttamente dopo una visita di servizio da parte di un tecnico ROKH SRL per apparecchi fino a 3 anni di età.</li>
