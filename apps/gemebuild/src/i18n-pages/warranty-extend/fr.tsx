  ...
  items: [
    {
      ...
      description: `
        ...
        <li class="mb-5">Les extensions de garantie existantes de deux ans peuvent être prolongées pour un maximum de 3 ans au cours de leur période de garantie.</li>
        <li class="mb-5">ROKH SRL a le droit d’ajuster ses prix à tout moment. Lors de l’achat d’une extension de garantie, le prix en vigueur au moment de la signature du contrat s’applique. L'évolution du prix d'une extension de garantie de deux ans peut être indiquée sur la facture annuelle. Aucune information écrite préalable ne sera fournie. Si la facture est payée dans le délai de paiement, on suppose que le changement de prix a été accepté. Si le paiement est refusé, la période de garantie ne sera pas prolongée.
    ...
    },
    {
      ...
      description: `
        ...
        <li class="mb-5">Le document de politique doit être enregistré et signé pendant la période de garantie de deux ans de l'équipement. Une extension de garantie de deux ans peut également être obtenue directement après une visite de service par un technicien ROKH SRL pour les appareils jusqu'à 3 ans.</li>
