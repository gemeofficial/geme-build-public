...
function ScrollablePdpTabs({ tabs, anchorOffset }: IScrollablePdpTabsProps) {
  ...
  return (
    <>
      ...
      >
        <ul className="overflow-auto v2311-title-h5 md:v2311-button-large-selected xl:v2311-body-large text-white py-2 px-1 md:py-[14px] md:px-8 flex flex-row space-x-4 md:space-x-6 xl:space-x-12 xl:mx-auto xl:w-max">
          {tabs.map((tab) => (
            <li key={tab.id}>
              <Link
